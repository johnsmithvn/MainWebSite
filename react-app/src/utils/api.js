...
export const apiService = {
  ...
  movie: {
    ...
    toggleFavorite: (path, key) => api.post(`${API.ENDPOINTS.MOVIE}/favorite-movie`, { path, key }),
  ...
  music: {
    ...
    getFavorites: (params) => api.get(`${API.ENDPOINTS.MUSIC}/favorite-music`, { params }),
    toggleFavorite: (path, key) => api.post(`${API.ENDPOINTS.MUSIC}/favorite-music`, { path, key }),
